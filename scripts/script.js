...
var derdeStreepjesButton = document.querySelector(
  "section.streepjes li:nth-of-type(3) button"
);
derdeStreepjesButton.onclick = derdeStreepjesButtonKlik;
function derdeStreepjesButtonKlik() {
  if (derdeStreepjesButton.ariaExpanded == "false") {
    derdeStreepjesButton.ariaExpanded = "true";
  } else {
    derdeStreepjesButton.ariaExpanded = "false";
  }
}
